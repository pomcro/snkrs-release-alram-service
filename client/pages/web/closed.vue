<template>
	<div>
		<Grid :item-data="list" :view-type="'C'" @list-method="nextPage"></Grid>
	</div>
</template>
...
export default {
	...
	*/
	...
	head() {
		return {
			title: `SNKRS98 | 스니커즈98 - 마감임박 응모 사이트`,
			description: `마감이 얼마 남지 않은 한정판 스니커즈 응모 정보를 확인하세요.`,
			meta: [
				{
					hid: 'description',
					name: 'description',
					content: `마감이 얼마 남지 않은 한정판 스니커즈 응모 정보를 확인하세요.`,
				},
				{
